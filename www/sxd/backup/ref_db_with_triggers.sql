#SXD20|20008|50140|50303|2012.01.02 19:25:11|ref_db|0|22|1599|
#TA acl_group_roles`72`936|acl_roles`38`1652|acl_user_groups`2`144|acl_users`14`1172|author`11`1160|author_organization`8`56|author_publication`67`759|cities`1321`37060|issue`6`764|issue_type`4`136|keywords`0`0|library_link_list`3`52|library_list`7`180|news`1`112|object_keywords`0`0|organization`3`444|publication`18`2332|publication_type`3`132|publisher`2`72|set_report_basement`1`64|set_report_head`6`380|settings`12`1088
#PR checkForDuplicateAuthor|deleteAuthorById|deleteAuthorFromPublicationById|deleteGroupById|deleteIssueById|deleteLibraryList|deleteOrgById|deletePubFromList|deletePublicationById|deletePublisherById|deleteReportBasementById|deleteUserById|getAllAuthors|getAllAuthorsByOrg|getAllIssues|getAllIssueTypes|getAllOrgs|getAllPublicationsOfAuthor|getAllPublicationsOfAuthorById|getAllPublicationsOfPublisher|getAllPublicationTypes|getAllPublishers|getAllUserGroups|getAllUsers|getAuthor|getAuthorById|getAuthorName|getAuthorsCreatedByUser|getBasementForReport|getIssueById|getIssuesCreatedByUser|getLibraryLists|getNameForReport|getNewPublicationsAmount|getNews|getNewsByID|getOrgById|getOrgsBreadcrumbs|getOrgsByParentId|getOrgsCreatedByUser|getPublicationById|getPublicationFromLibrary|getPublicationFromList|getPublicationsCreatedByAuthor|getPublisherById|getPublishersCreatedByUser|getPubsAmountByAuthorByType|getPubsAmountOfAuthorByType|getUserById|getUserByName|getUserId|insertAuthor|insertFirstHead|insertGroup|insertIssue|insertLibraryList|insertLinkToLibrary|insertOrg|insertPublication|insertPublisher|insertQuickAuthor|insertToReportBasement|new_proc0|searchByAuthor|searchByName|searchByOrg|searchByPublisher|securityCheck|updateAuthorById|updateIssueById|updateOrgById|updatePublicationById|updatePublicationStatus|updatePublisherById|updateReportBasement|updateReportName|updateReportType|updateUserById
#FU checkSecurityGroup|concat_authors|getIssueName|getOrg|getOrgBCrumbs|getOrgId|getOrgName|getPublisherName
#TR deleteUserCascade|deleteLibListCascade|deletePublicationCascade
#EOH
...
(16,0,'dimour@mail.ru','342a79337d236acc9f1b5f79f36cb687','0l9z1kk2g42863p0003nxn8a0e3141k8',2,0),
(17,6,'vargin.german@gmail.com','bf6a73e6a5b12434ec93ef60d93df7e0','',2,1),
(18,32,'komar-ik@inbox.ru','1f32aa4c9a1d2ea010adcf2348166a04','',2,1),
...
) ENGINE=MyISAM AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='авторы'	;
...
(32,0,'Белашенкова','Наталья','Николаевна','1988-11-15','woman',111111,'komar-ik@inbox.ru','','',''),
...
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='организация'	;
...
) ENGINE=MyISAM AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COMMENT='таблица публикаций (статей, монографий, методических указани'	;
...
(7,3,1,'Онтологический инжиниринг в системе Protege ',0,2,0,2007,0,64,0,'','0'),
(22,14,3,'Semantic Social Profile: a semantic boost for Social Profiles in MediaWiki',1,0,4,0000,0,325,321,'paper6.pdf','0'),
(24,14,1,'окегокео',0,0,0,0000,0,0,0,'','пегпе'),
(32,3,1,'СДО и методы защиты',0,2,0,0000,0,0,0,'','0'),
(33,19,1,'Концептуальное моделирование знаний в системе Cmap Tools',0,2,0,2009,0,83,0,'','0'),
(34,19,1,'Системы инженерии знаний',0,2,0,2009,0,60,0,'','0'),
(35,19,1,'Онтологический инжиниринг в системе Protege ',0,2,0,2007,0,64,0,'','0'),
(36,19,1,'Интеллектуальные технологии в менеджменте',0,2,0,2008,0,488,0,'','0'),
(37,19,1,'Оболочка экспертных систем Exsys CORVID',0,2,0,2006,0,69,0,'','0'),
(38,19,1,'Практические основы метода газоразрядной визуализации',0,2,0,2006,0,128,0,'','0'),
(39,19,1,'Введение в технологию экспертных систем',0,2,0,2005,0,106,0,'','0'),
(40,5,2,'Веб-платформа для разработки и эксплуатации продукционных экспертных систем',5,0,0,0000,0,191,193,'','0'),
(41,5,2,'Анализ вариантов интеграции продукционных экспертных систем и OWL-онтологий',6,0,0,0000,0,283,0,'','0')	;
...
(2,3,'report.head','Семерханова Ильи Александровича','','',2),
...
(13,15,'report.head','Смирнов Павел Андреевич ','','',1),
...
SET query_ = "SELECT `checkSecurityGroup`(u.`id`, p.`creator_id`) AS permission FROM `";
...
END	;
#	PR`updatePublicationStatus`utf8_general_ci	;
...
IF STAT = '1' THEN	
	UPDATE  `author_publication` ap SET  ap.`status` =  STAT 
...
RETURN res;
END	;
#	TR`deleteUserCascade`cp1251_general_ci	;
CREATE TRIGGER `ref_db`.`deleteUserCascade` AFTER DELETE
    ON ref_db.acl_users FOR EACH ROW
BEGIN
    DELETE FROM settings WHERE user_id = old.id;
END	;
#	TR`deleteLibListCascade`cp1251_general_ci	;
CREATE TRIGGER `ref_db`.`deleteLibListCascade` AFTER DELETE
    ON ref_db.library_list FOR EACH ROW
BEGIN
    DELETE FROM library_link_list WHERE list_id = old.id;
END	;
#	TR`deletePublicationCascade`cp1251_general_ci	;
CREATE TRIGGER `ref_db`.`deletePublicationCascade` AFTER DELETE
    ON ref_db.publication FOR EACH ROW
BEGIN
    DELETE FROM author_publication WHERE id_publication = old.id;
END	;
